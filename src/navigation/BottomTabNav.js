		...
		<BottomTabs.Navigator
			...
			<BottomTabs.Screen
				...
				options={{
					...
					tabBarTestID: 'trackTab'
				}}
			/>
			<BottomTabs.Screen
				name="Search"
				component={SearchScreen}
				options={{ tabBarIcon: iconProvider('Search'), tabBarTestID: 'searchTab' }}
			/>
			<BottomTabs.Screen
				name="Radio"
				component={Radio}
				options={{ tabBarIcon: iconProvider('Radio'), tabBarTestID: 'radioTab' }}
			/>
			<BottomTabs.Screen
				name="Library"
				component={LibraryStack}
				options={{ tabBarIcon: iconProvider('Library'), tabBarTestID: 'libraryTab' }}
			/>
			<BottomTabs.Screen
				name="Settings"
				component={SettingsScreen}
				options={{ tabBarIcon: iconProvider('Settings'), tabBarTestID: 'settingsTab' }}
			/>
		</BottomTabs.Navigator>
	);
}
