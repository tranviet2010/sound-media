	...
	return (
		<Dialog.Container
			...
			<DialogInput
				...
				autoFocus
			/>
			<Dialog.Button testID="cancelButton" label="Cancel" color={contrast} onPress={onCancel} />
			<Dialog.Button testID="saveButton" label={saveButtonTitle} color={foreground} onPress={onSave} />
		</Dialog.Container>
	);
}
